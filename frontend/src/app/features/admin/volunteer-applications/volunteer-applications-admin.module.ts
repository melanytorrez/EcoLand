...
import { LucideAngularModule, CheckCircle2, Clock3, Loader2, MessageSquareText, XCircle, Leaf, BadgeInfo } from 'lucide-angular';
...
@NgModule({
  ...
  imports: [
    ...
    TranslateModule,
    LucideAngularModule.pick({ CheckCircle2, Clock3, Loader2, MessageSquareText, XCircle, Leaf, BadgeInfo })
  ]
})
